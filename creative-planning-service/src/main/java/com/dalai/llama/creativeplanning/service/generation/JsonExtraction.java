...
/** Every JSON-parsing generation call in this package requests JSON mode at the API level (see
...
public final class JsonExtraction {
     ...
     * (ideas, scripts for investor / market-education / B2B briefs) where the model needs real
     * numbers, and stick with plain JSON_MODE_PARAMS for critic passes and other reasoning-only
     * calls that would only distract from the grounding budget. */
