...
/** critic-service's two real callers (pre-production-service, creative-planning-service) are
 ...
 * this is the same {@code CritiqueOrchestrator}/{@code MarketingPlanCritiqueOrchestrator}, just
 * reached without a JWT the calling service never actually had to forward. */
@RestController
...
public class InternalCritiqueController {
    ...
    public InternalCritiqueController(CritiqueOrchestrator critiqueOrchestrator, MarketingPlanCritiqueOrchestrator marketingPlanCritiqueOrchestrator) {
