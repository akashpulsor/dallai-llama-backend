 ...
 * a ```json ... ``` fence if a model wraps its output in one anyway. Copy of the marketing-plan
 * critique package's own {@code JsonExtraction}, since that one is package-private. */
