package com.dalai.llama.chat.service.generation;

import java.util.Map;

/** Requests JSON mode at the API level (llm-gateway's {@code response_format=json} param), so
 * this is a safety net, not the primary defense -- strips a ```json ... ``` fence if the model
