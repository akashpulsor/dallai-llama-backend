...
public class TokenControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public ErrorMessage handleInvalidVerificationCode(InvalidVerificationCodeException ex, WebRequest request) {
        return new ErrorMessage(
                HttpStatus.FORBIDDEN.value(),
                new Date(),
                ex.getMessage(),
    ...
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public ErrorMessage handleExpiredVerificationCode(ExpiredVerificationCodeException ex, WebRequest request) {
        return new ErrorMessage(
                HttpStatus.FORBIDDEN.value(),
                new Date(),
                ex.getMessage(),
    ...
    @ResponseStatus(HttpStatus.UNAUTHORIZED)
    public ErrorMessage handleInsufficientAuthenticationException(InsufficientAuthenticationException ex, WebRequest request) {
        return new ErrorMessage(
                HttpStatus.UNAUTHORIZED.value(),
                new Date(),
                ex.getMessage(),
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ErrorMessage handleInsufficientAuthenticationException(Exception ex, WebRequest request) {
        return new ErrorMessage(
